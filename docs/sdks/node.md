...
id: node
title: Node.js SDK
description: Full reference for the GateCtr Node.js SDK (@gatectr/sdk). Install, initialize, make completions, stream responses, and drop in for the OpenAI SDK.
keywords: [Node.js SDK, TypeScript, npm, OpenAI compatible, LLM SDK]
